...
from prov.model import ProvBundle, ProvAgent, ProvActivity, ProvEntity
...
def testing_bundle(bundle: ProvBundle):
    ...
    tplanning = bundle.activity("TestPlanning", "2022-11-01T10:30:00", "2022-11-10T10:30:00",
                                other_attributes={"prov:location": "Conference Room, Company"})
...
def deployment_bundle(bundle: ProvBundle):
    ...
    ug = bundle.entity("UserGuides",
                       {"dct:description": "User guides simplify software adoption with essential instructions."})
